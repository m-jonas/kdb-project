/ monitor.q - Tickerplant Prometheus Exporter
...
/ 3. Wrap Tickerplant Update Function (.u.upd)
/ We only look for .u.upd because this is strictly for the TP now
...
-1 ">>> Prometheus Exporter loaded (TP Mode).";